...
PYBIND11_MODULE(pyopenface, m){
    ...
    face_analyser.def(py::init<FaceAnalyserParameters &>())
        ...
        .def("GetCurrentTimeSeconds", &FaceAnalyser::GetCurrentTimeSeconds)
        .def("GetCurrentAUsClass", &FaceAnalyser::GetCurrentAUsClass)
        .def("GetCurrentAUsReg", &FaceAnalyser::GetCurrentAUsReg)
        .def("PredictStaticAUsAndComputeFeatures", &FaceAnalyser::PredictStaticAUsAndComputeFeatures)
        .def("Reset", &FaceAnalyser::Reset)
        .def("GetLatestHOG", &FaceAnalyser::GetLatestHOG)
        .def("GetLatestNeutralHOG", &FaceAnalyser::GetLatestNeutralHOG)
        .def("GetTriangulation", &FaceAnalyser::GetTriangulation)
        .def("GetGeomDescriptor", &FaceAnalyser::GetGeomDescriptor)
        .def("GetAUClassNames", &FaceAnalyser::GetAUClassNames)
        .def("GetAURegNames", &FaceAnalyser::GetAURegNames)
        .def("GetDynamicAUClass", &FaceAnalyser::GetDynamicAUClass)
        .def("GetDynamicAUReg", &FaceAnalyser::GetDynamicAUReg)
        .def("ExtractAllPredictionsOfflineReg", &FaceAnalyser::ExtractAllPredictionsOfflineReg)
        .def("ExtractAllPredictionsOfflineClass", &FaceAnalyser::ExtractAllPredictionsOfflineClass)
        .def("PostprocessOutputFile", &FaceAnalyser::PostprocessOutputFile)
        .def("GetCurrentAUsCombined", &FaceAnalyser::GetCurrentAUsCombined)
        .def("GetLatestAlignedFace", &FaceAnalyser::GetLatestAlignedFace);
